...
class EmployeService {
     ...
     */
    void embaucheEmploye(String nom, String prenom, Poste poste, NiveauEtude niveauEtude, Double tempsPartiel) throws EmployeException {
    ...
    public void calculPerformanceCommercial(String matricule, Long caTraite, Long objectifCa) throws EmployeException {
        ...
        int performance = getBasePerformance(caTraite, objectifCa, employe);
     ...
     * @param objectifCa
     * @param employe
     * @return la perfomance
     */
    private int getBasePerformance(Long caTraite, Long objectifCa, Employe employe) {
